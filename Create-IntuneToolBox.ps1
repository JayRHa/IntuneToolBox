...
'@
    ...
    $iconGroupCount = @'
    iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAABmJLR0QA/wD/AP+gvaeTAAAAN0lEQVRIiWNgGAUDDRjhrIor/xkYGBgYOnQwxcgBUHOYyDZgxIDROBgFlIPRVDTwYDQORgHlAADHmRgNDUab0wAAAABJRU5ErkJggg==
'@
...
function Add-GroupsToGrid{
	...
	$WPFListViewAllGroups.ItemsSource = $script:DevicesObservableCollection

	$WPFLabelCountGroups.Content = "$($WPFListViewAllGroups.Items.Count) Groups"
}
...
$WPFListViewMenu.Add_SelectionChanged( {
    ...
    switch($WPFListViewMenu.SelectedItem.Name){
        ...
        ItemGroupManagement {
            ...
            Add-GroupsToGrid -AllGroups $allGroups
        }
    }
})
###########################################################################################################
